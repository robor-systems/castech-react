...
const PrivacyPolicy = () => {
  return (
    <div className="my-[180px] px-[40px] md:px-[120px] text-text-primary">
      ...
      <h2 className="text-[20px] text-text-dark mt-[20px]">
        Collecting and using your personal data
      </h2>
      <h3 className="text-text-dark mt-[20px] font-semibold ">Usage data</h3>
      ...
      <h2 className="text-text-dark text-[16px] font-semibold mt-[20px]">
      ...
      <ul className="list-disc">
        <li className="mt-[20px]">
          <p className="text-text-dark font-bold">Cookies or browser cookies</p>{" "}
      ...
      <h2 className="mt-[16px] text-text-dark font-semibold">Usage data</h2>
      <p className="mt-[20px]">
        Usage data is collected automatically when using the service.
      </p>
      <p className="mt-[20px]">
