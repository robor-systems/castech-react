...
const Career = () => {
  return (
    <div className="mt-[140px] flex justify-between px-[40px] md:px-[100px] lg:px-[200px]">
      <div className="relative">
        <img
          src={photo}
          alt="groupimage"
          className="w-[312px] md:w-[496px] h-[239px] md:h-[380px]   rounded-[35px] md:rounded-[80px] relative z-10 mt-[30px] md:mt-[0px]"
        />
      ...
      <div>
        <div className="text-text-secondary text-[14px]   ">WHY JOIN US</div>
        ...
        <p className="text-text-primary text-[14px] leading-[1.5rem]">
          ...
          organization. We <br /> care them and do whatever is possible to train
          and retain them. We maintain a <br /> policy of non-discrimination
          towards all employees and applicants for employment. <br />
          All aspects of employment with CASTechnology Inc. are governed by
          merit, <br /> competence, suitability and qualifications, and will not
          be influenced in any manner
          <br /> by gender, age, race, color, religion, national origin or
          disability
        </p>
        <p className="text-text-primary text-[14px] leading-[2rem]">
          Want to be a part of our team? Send your resumé for future opening at
        </p>
